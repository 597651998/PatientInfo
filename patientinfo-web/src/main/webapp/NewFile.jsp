	...
	<div id="dlg" class="easyui-dialog" style="width: 570px;height: 340px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table cellspacing="5px;">
				<tr>		
					<td>患者姓名：</td>
					<td><input class="easyui-combobox" id="patientName" name="patientName" style="width: 155px" data-options="panelHeight:'auto',editable:false,valueField:'patientName',textField:'patientName',url:'http://localhost:8080/patientinfo-web/patients_list'"/></td>
				</tr>
				<tr>
					<td>性别：</td>
