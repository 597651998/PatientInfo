...
<html lang="zh" class="no-js">
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/logincss/normalizelogin.css" />
		<link rel="stylesheet" type="text/css" href="css/logincss/demologin.css" />
		<link rel="stylesheet" type="text/css" href="css/logincss/componentlogin.css" />
		<link rel="stylesheet" type="text/css" href="css/logincss/contentlogin.css" />
	...
	<body>
		<div class="codrops-demos">
			...
			<section>
				<p>点击下面的按钮进行用户的<strong>注册</strong>:</p>
							...
							<div>
								<div class="content-style-form content-style-form-1">
									...
									<form method="post" id="firstform" action="123">
										<p><label>用户名</label><input name="userName" id="userName" type="text" /></p>
										<p><label>密   码</label><input name="password" id="password" type="password" type="password" /></p>
										<input  type="checkbox" name="isManager" style="float: left;"><p><label style="margin-top: -10px;">是否是管理员</label></p>
											<p><button onclick="subLoginInfo()">登录</button></p>
									</form>
								</div>
								<script>
							...
							<div>
								<div class="content-style-form content-style-form-2">
									...
									<form id="Registform" action="user/regist" method="post">
										<p><label>用 户名</label><input type="text" id="username" name="guahaousername" /></p>
										<p><label>密    码</label><input name="guahaopassword"  type="password" /></p>
										<p><label>手机号码</label><input type="text" name="phoneNumber"  /></p>
										<p><label>邮箱</label><input type="text" name="guahaoemail"  /></p>
										<p><button onclick="subRegistInfo()">注册</button></p>
									</form>
								</div>
								<script>
